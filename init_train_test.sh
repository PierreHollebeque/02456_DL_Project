python  util/data_cropper_average.py --average True --force_create True
...
python test.py --dataroot ./datasets/mock_images/testA --name mock_model_resnet_1 --model_suffix _A --no_dropout
python test.py --dataroot ./datasets/mock_images/testA --name ifr_model_resnet --model_suffix _A --no_dropout
